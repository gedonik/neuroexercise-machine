    ...
    <div className={styles.headerInfo}>
      ...
      <address className={styles.headerAddress}>
        <div className={styles.headerAddress__contacts}>
          <a className={styles.headerAddress__phone} href="tel:+7800554897">
            8(800) 55 48 97
          </a>
          <a
            className={styles.headerAddress__mail}
            href="mailto:info@neyro-t.ru"
          >
            info@neyro-t.ru
          </a>
        </div>
        <span>
          <em>Время работы:</em> 07:00 - 19:00 по МСК
        </span>
      </address>
